...
public class DateOfBirthActivity extends AppCompatActivity {
    ...
    ArrayAdapter dateArrayAdapter;
    ArrayAdapter monthArrayAdapter;
    ArrayAdapter yearArrayAdapter;
    ...
    public void setDateAdapter() {
        dateArrayAdapter = new ArrayAdapter(this, android.R.layout.simple_spinner_dropdown_item, dates);
    }

    public void connectAdapter() {
        dateSp.setAdapter(dateArrayAdapter);
    }

    public void setMonthAdapter() {
        monthArrayAdapter = new ArrayAdapter(this, android.R.layout.simple_spinner_dropdown_item, months);
    }

    public void connectMonthAdapter() {
        monthSp.setAdapter(monthArrayAdapter);
    }

    public void setYearsAdapter() {
        yearArrayAdapter = new ArrayAdapter(this, android.R.layout.simple_spinner_dropdown_item, years);
    }

    public void connectYearsAdapter() {
        yearSp.setAdapter(yearArrayAdapter);
    }
}